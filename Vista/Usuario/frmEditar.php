            ...
            <form method="POST" action="?controlador=usuario&accion=editar" id="frm" onsubmit="return false;">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" id="nombres" name="nombres"  value="<?php echo $this ->infoUsuario["USU_NOMBRES"];?>">
                      
                    </div>
                     <div class="col-lg-6">
                        <label for="apellidos" class="form-label">Apellidos</label>
                        <input type="text" class="form-control" id="apellidos" name="apellidos"value="<?php echo $this ->infoUsuario["USU_APELLIDOS"];?>">
                    </div>

                     <div class="col-lg-6">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control" id="email" name="email"value="<?php echo $this ->infoUsuario["USU_EMAIL"];?>">
                    </div>
