        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-secundary"><i class="fa fa-hashtag me-2"></i>Mi Oro</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    <a href="?controlador=inicio&accion=dashboard" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Inicio</a>
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="Public/img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Juanillo: 'Ya terminaron el proyecto? estan atrasados!</h6>
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="Public/img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Juanillo: investiguen!</h6>
                                        <small>15 minutes ago</small>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                        <a href="?controlador=Perfil&accion=principal" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Mi perfil</a>
